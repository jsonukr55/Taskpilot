...
export const RELEASE_NOTES: ReleaseNote[] = [
  {
    ...
    items: [
      ...
      { type: 'added',    text: 'Command palette — press Ctrl/⌘+K to jump anywhere, create a task/note/group, open Calendar/Groups/Analytics, change theme, or run a search, all from the keyboard.' },
      { type: 'added',    text: 'Universal search — the top search bar now finds tasks, notes, groups, categories, people, daily reports and the calendar at once, with fuzzy matching and arrow-key navigation.' },
      { type: 'added',    text: 'Smarter Daily Report — one-click blocker suggestions from overdue tasks, plus AI-generated Professional, Manager and Teams summaries of the day.' },
